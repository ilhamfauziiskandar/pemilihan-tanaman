...
<body class="hold-transition login-page" style="background-image: url(<?= base_url('/lipi.jpeg') ?>);background-repeat: no-repeat;
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form action="<?= base_url('login/check_login') ?>" method="post">
          ...
          <div class="row">
            <div class="col-6">
              <a href="<?= base_url('login/register') ?>" class="text-center">Register Account</a>
            </div>
            <!-- /.col -->
            <div class="col-6">
